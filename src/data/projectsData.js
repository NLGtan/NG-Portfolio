...
export const projects = [
  {
    ...
    description:
      "A Flutter mobile app connecting homeowners and tenants. It includes role-based dashboards, bill tracking, OCR-based submeter reading, push notifications, and Supabase image uploads. The app also integrates a blockchain payment method to ensure secure, immutable bill records.",
